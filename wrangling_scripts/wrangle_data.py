...
def cleandata(dataset, keepcolumns = ['Country Name', '1990', '2015'], value_variables = ['1990', '2015']):
    ...
    top10country = ['Pakistan', 'China', 'India', 'Indonesia', 'Japan']
...
def return_figures():
  ...
  # as a line chart
    ...
    graph_one = []
    df = cleandata('data/arableland.csv')
...
# third chart plots percent of population that is rural from 1990 to 2015
    graph_three = []
    df = cleandata('data/percentruralpopulation.csv')
...
# fourth chart shows rural population vs arable land
    ...
    df_one = cleandata('data/ruralpopulation.csv', keepcolumns, valuevariables)
    df_two = cleandata('data/arableland.csv', keepcolumns, valuevariables)
    ...
    graph_five = []
    df_five = cleandata('data/ruralpopulation.csv', ['Country Name', '2015'], ['2015'])
